...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('kmar',0,'klasse4','4de klasse',20,'{}','{}'),
	('kmar',1,'klasse3','3de klasse',20,'{}','{}'),
	('kmar',2,'klasse2','2de klasse',40,'{}','{}'),
	('kmar',3,'klasse1','1ste klasse',60,'{}','{}'),
	('kmar',4,'wachtmeester','Wachtmeester',20,'{}','{}'),
	('kmar',5,'opperwachtmeester','Opperwachtmeester',20,'{}','{}'),
	('kmar',6,'onderofficier','Onderofficier',20,'{}','{}'),
	('kmar',7,'eersteluitenant','Eerste luitenant',800,'{}','{}'),
	('kmar',8,'kolonel','Kolonel',850,'{}','{}'),
	('kmar',9,'generaalmajoor','Generaal Majoor',950,'{}','{}'),
	('kmar',10,'boss','Luitenant Generaal',1000,'{}','{}'),
	('kmar',11,'bsb','BSB',1200,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de kmar',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de kmar',110,1),
